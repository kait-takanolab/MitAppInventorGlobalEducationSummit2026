...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/kait-takanolab/MitAppInventorGlobalEducationSummit2026
   cd github/MitAppInventorGlobalEducationSummit2026
...
1. **Select a topic:**
    Choose a topic from the dropdown list in the top-left corner. (Note: Each topic name corresponds to a target block image in the GitHub image folder).

2. **Create blocks:**
    Assemble the programming blocks according to the topic you selected in step 1.

3. **Run the simulation:**
    Click the Start simulation button in the top-left corner.

4. **Wait for results:**
    After a brief waiting period, the simulation results based on your block sequence will be displayed.
